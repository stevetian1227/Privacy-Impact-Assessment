...
console.log(deleteBtnElements);
// get the input for the deleteRegulation
let deleteInput = document.getElementById("deleteRegulation");
//console.log(deleteBtnElements);
for (let i=0;i< deleteBtnElements.length;i++){
    ...
    currentBtn.addEventListener('click', ()=>{
        ...
        document.getElementById("deleteRegulation").value = currentDeleteData;
    })
}